...
describe('Board component', function() {
	it('Renders the board which containts the list container', function() {
		...
		listFunctionOne.props.title.should.equal('List A');
		
		const listFunctionTwo = result.props.children[2];
		listFunctionTwo.type.should.be.a('function');
		listFunctionTwo.props.title.should.equal('List B');
	})
})